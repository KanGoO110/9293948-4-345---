...
client.on('ready', () => {
  client.user.setGame(` By KanGoO#2262 .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
  console.log('KN | SHOP Is Online')
  console.log('---------------')
});
...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","KanGoO#2262")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`KN|SHOP - Script By : KanGoO`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : KanGoO#2262 ' `);
    console.log(`----------------`);
